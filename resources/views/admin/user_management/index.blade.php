                ...
                <div class="card border-0 shadow-sm rounded-3">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="text-muted small fw-bold text-uppercase mb-2" style="letter-spacing: 0.5px;">Total
                                    Register Users</h6>
                ...
                <div class="card border-0 shadow-sm rounded-3">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="text-muted small fw-bold text-uppercase mb-2" style="letter-spacing: 0.5px;">
                                    Joined in {{ now()->subMonth()->format('F') }}</h6>
                ...
                <div class="row align-items-center g-3">
                            ...
                            <div class="col-auto">
                                ...
                                @if (request('search') || request('from_date'))
                                    <a href="{{ route('admin.user.management') }}"
                                        class="btn btn-sm btn-light border px-3">Reset</a>
                                @endif
                            </div>
                        </form>
                    </div>
                    ...
                    @if (request('search') || (request('from_date') && request('to_date')))
                        <div class="col-md-3 text-md-end">
                            <div
                                class="alert alert-success border-0 py-2 px-3 mb-0 d-inline-block rounded-pill small fw-bold shadow-sm">
                                ...
                                <tr>
                                    ...
                                    <td class="text-start">
                                        <div class="fw-bold text-dark">
                                            ...
                                            @else
                                                <span class="text-danger small">No Name Provided</span>
                                            @endif
                                        </div>
                                    </td>
                                    {{-- <td class="text-start">
                                    ...
                                    <td>
                                        <div class="small fw-bold text-dark convert-to-local-date"
                                            data-utc="{{ $user->created_at->toIso8601String() }}">
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-success-subtle text-success border border-success-subtle px-3 py-2 rounded-pill small fw-bold">
