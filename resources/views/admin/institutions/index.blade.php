...
<div class="container mt-5">
    <div class="card shadow-sm">
        ...
        <div class="card-body p-0"> <!-- p-0 for better table fit -->
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($item->website)
                                    <a href="{{ $item->website }}" target="_blank" class="btn btn-sm btn-link p-0 text-decoration-none">Visit</a>
                                @else
                                    -
                                @endif
                            </td>
        ...
        <div class="card-footer bg-white pt-3">
            <div class="d-flex justify-content-center">
                {{-- এখানে বুটস্ট্র্যাপ ৫ এর জন্য পাথ সরাসরি লিখে দেওয়া হয়েছে --}}
