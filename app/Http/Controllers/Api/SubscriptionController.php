        ...
        $plans = Plan::where('status', 'active')
            ...
            ->where(function ($query) {
                $query->whereNotNull('stripe_price_id')
                    ->orWhereNotNull('revenuecat_store_identifier')
                    ->orWhereNotNull('revenuecat_store_identifier_ios')
                    ->orWhereNotNull('revenuecat_store_identifier_android');
            })
            ->orderBy('billing_rate')
            ->get(['id', 'name', 'short_description', 'billing_cycle', 'plan_type', 'billing_rate', 'badge_color', 'features', 'stripe_price_id', 'revenuecat_store_identifier', 'revenuecat_store_identifier_ios', 'revenuecat_store_identifier_android']);
